...
<html>
  ...
  " >  Buscar  </button>
            ...
            <a href="administrarusuarios.jsp"><button name="reset" type="button" value="reset"style="
  ...
  " >  Limpiar  </button></a>
            ...
            %>
            <h1 style="padding-left: 205px">Administrar usuarios</h1>
         ...
         <table  width="95%">
            ...
            <% 
                ...
                try{
                    ...
                    if(buscar!=null){
                        rs=sta.executeQuery("SELECT * FROM cliente where nombre LIKE "+"'%"+buscar+"%'");
                    }
                 ...
                 <tr> 
                   ...
                   <!--  <th><a href="actualizarproducto.jsp?id=<%//=rs.getString(1)%>"> 
                     <img src="imagenes/actualizar.png" width="40" height="35"></a></th> -->
                      ...
                      <th>No se puede<br>eliminar este<br>usuario</th>
                     
                     <%}else{%> 
                      <th><a href="eliminarusuario.jsp?id=<%=rs.getString(1)%>"> 
