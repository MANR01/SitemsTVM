...
<html>
    <body>
        ...
        <%
                    ...
                    ResultSet rs=null;
                    String idp=null, nombre=null,descripcion=null,precio=null,modelo=null,categoria=null,cantidad=null;
                    ...
                    sta.executeUpdate("insert into favoritos values('"+idcliente+"','"+idp+"','"+nombre+"','"+descripcion+"',"+precio+","+modelo+",'"+categoria+"','"+cantidad+"',"+i+" )");
